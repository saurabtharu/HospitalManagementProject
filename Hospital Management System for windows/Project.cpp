...
void Doctor::addDoctorInfo()
{
    ...
    if (docNo == 0)
    {
        ...
        cout << "\n\t\t\t\t  Press any key to enter number of doctors again!!" << endl;
        cin.get();
        system("cls");
        goto abc;
    }
...
void Doctor::displayDoctorInfo()
{
    ...
    else
    {
        ...
        cout << "\n\t\t\t\t\t\t\tPress any key To choose another Option . . . " << endl;
    }
    cin.get();
}
...
{   
    ...
    if (patNo == 0)
    {
        ...
        {
            // cout << "\t\t\tAdding Information on patient's file on: " << time101 << endl;
...
void Patient::displayPatientInfo(){
    ...
    else
    {
        ...
        if (flag == 1)
        {
            ...
            cout << "\t\t\t\t\t\t\t\t\tInformation of Patients " << endl;
            cout << "\t\t\t\t\t\t\t-" << setfill('-') << setw(50) << "-" << endl;
            // cout << "" << time101 << endl;
            ...
            switch (choice2)
            {
                case 1:
                    ...
                    switch (choice3)
                    {
                        ...
                        default:
                            cout << "\n\t\t\t\t\t\t    Invalid choice : " << choice3 << endl << endl;
                            sleep(2);
                            goto label3;
                            break;
                    }
                ...
                case 2:
                    ...
                    switch (choice4)
                    {
                        ...
                        default:
                            cout << "\n\t\t\t\t\t\t    Invalid choice : " << choice4 << endl << endl;
                            sleep(2);
                            goto label4;
                            break;
                    }
                ...
                case 3:
                    ...
                    break;
                default:
                    cout << "\n\t\t\t\t\t\t    Invalid choice: " << choice2 << endl << endl;
                    sleep(2);
                    goto label2;
            }
            break;
